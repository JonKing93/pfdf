...
.. toctree::
    ...
    data package <data/index>
    errors module <errors>
    models package <models/index>
    projection package <projection/index>
    raster package <raster/index>
    segments package <segments>
    severity module <severity>
    utils package <utils/index>
    watershed module <watershed>
