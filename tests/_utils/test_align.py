...
class TestReprojection:
    def test_resolution_overlapping(_, crs):
        ...
        output = align.reprojection(crs, crs, bounds, transform)
    ...
    def test_resolution_no_overlap(_, crs):
        ...
        aligned, shape = align.reprojection(crs, crs, bounds, ttransform)
        assert shape == (5, 5)
    ...
    def test_resolution_alignment(_, crs):
        ...
        assert np.allclose(transform.aslist()[:-1], expected.aslist()[:-1])
